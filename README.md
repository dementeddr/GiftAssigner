...
The randomization can now be seeded. By default it is seeded with System.currentTimeMillis();
...
* Allow the tool to use the mirrorPartner logic on groups that are not all pairs of partners, by randomly pairing otherwise unpaired people.
